...
TTextAttributes::TTextAttributes(void): TPersistent() {
  FGraphic = NULL;
}

//---------------------------------------------------------------------------
TTextAttributes::~TTextAttributes(void) {
  delete FGraphic;
}
...
int TTextAttributes::Get_Width(void) {
  return FGraphic->Width;
}

bool TTextAttributes::Set_Width(int NewWidth) {
...
int TTextAttributes::Get_Height(void) {
...
TGraphic *TTextAttributes::Get_Graphic(void) {
  return FGraphic;
}

bool TTextAttributes::Set_Graphic(TGraphic *NewGraphic) {
...
TBitmap *TTextAttributes::Get_Bitmap(void) {
  return dynamic_cast<TBitmap *>(FGraphic);
}

bool TTextAttributes::Set_Bitmap(TBitmap *NewBitmap) {
...
bool FASTCALL TTextAttributes::LoadFromResourceName(HINSTANCE hInstance, const AnsiString ResName) {
...
//---------------------------------------------------------------------------
bool FASTCALL TTextAttributes::LoadFromFile(const AnsiString asFileName) {
...
//---------------------------------------------------------------------------
bool FASTCALL TTextAttributes::SaveToFile(const AnsiString asFileName) {
...
//---------------------------------------------------------------------------
void TTextAttributes::GetListProperties(TStrings *ListProperties) {
...
TYPEPROPERTY TTextAttributes::GetTypeProperty(AnsiString asProperty, AnsiString *asInfos) {
...
AnsiString TTextAttributes::GetDefaultProperty(AnsiString asProperty) {
...
AnsiString TTextAttributes::GetProperty(AnsiString asProperty) {
...
bool TTextAttributes::SetProperty(AnsiString asProperty, AnsiString asValue,
                              TPersistent *Sender) {
