...
TParaAttributes::TParaAttributes(void): TPersistent() {
  FGraphic = NULL;
}

//---------------------------------------------------------------------------
TParaAttributes::~TParaAttributes(void) {
  delete FGraphic;
}
...
int TParaAttributes::Get_Width(void) {
  return FGraphic->Width;
}

bool TParaAttributes::Set_Width(int NewWidth) {
...
int TParaAttributes::Get_Height(void) {
  return FGraphic->Height;
}

bool TParaAttributes::Set_Height(int NewHeight) {
...
TGraphic *TParaAttributes::Get_Graphic(void) {
  return FGraphic;
}

bool TParaAttributes::Set_Graphic(TGraphic *NewGraphic) {
...
TBitmap *TParaAttributes::Get_Bitmap(void) {
  return dynamic_cast<TBitmap *>(FGraphic);
}

bool TParaAttributes::Set_Bitmap(TBitmap *NewBitmap) {
...
bool FASTCALL TParaAttributes::LoadFromResourceName(HINSTANCE hInstance, const AnsiString ResName) {
...
//---------------------------------------------------------------------------
bool FASTCALL TParaAttributes::LoadFromFile(const AnsiString asFileName) {
...
//---------------------------------------------------------------------------
bool FASTCALL TParaAttributes::SaveToFile(const AnsiString asFileName) {
...
//---------------------------------------------------------------------------
void TParaAttributes::GetListProperties(TStrings *ListProperties) {
...
TYPEPROPERTY TParaAttributes::GetTypeProperty(AnsiString asProperty, AnsiString *asInfos) {
...
AnsiString TParaAttributes::GetDefaultProperty(AnsiString asProperty) {
...
AnsiString TParaAttributes::GetProperty(AnsiString asProperty) {
...
bool TParaAttributes::SetProperty(AnsiString asProperty, AnsiString asValue,
                              TPersistent *Sender) {
