...
int TPNGFile::Get_Width(void) {
  return FWidth;
}

bool TPNGFile::Set_Width(int NewWidth) {
...
int TPNGFile::Get_Height(void) {
  return FHeight;
}

bool TPNGFile::Set_Height(int NewHeight) {
...
int TPNGFile::Get_BitCount(void) {
  return FBitCount;
}

bool TPNGFile::Set_BitCount(int NewBitCount) {
...
HPALETTE TPNGFile::Get_Palette(void) {
  return FPaletteVCL.Handle;
}

bool TPNGFile::Set_Palette(HPALETTE NewPalette) {
...
TPaletteVCL *TPNGFile::Get_PaletteVCL(void) {
  return &FPaletteVCL;
}

bool TPNGFile::Set_PaletteVCL(TPaletteVCL *NewPaletteVCL) {
...
//---------------------------------------------------------------------------
// Lecture d'un PNG à partir d'un flux
//---------------------------------------------------------------------------

BOOL TPNGFile::LoadFromStream(TStream *Stream, TCHAR *szMsgErreur) {
...
//---------------------------------------------------------------------------
// Lecture d'un fichier PNG
//---------------------------------------------------------------------------

BOOL TPNGFile::LoadFromFile(const TCHAR * szFileName, TCHAR *szMsgErreur) {
	TFileStream BitmapStream(szFileName, fmOpenRead | fmShareDenyNone);
	return LoadFromStream(&BitmapStream, szMsgErreur);
}

//---------------------------------------------------------------------------
// Ecriture d'un fichier PNG
//---------------------------------------------------------------------------

BOOL TPNGFile::SaveToStream(TStream *Stream, TCHAR *szMsgErreur) {
  BITMAPFILEHEADER bmfHeader;
  ...
  if (Ok) {
    ...
    if (dw != sizeof(BITMAPINFOHEADER)) {
      Ok = false;
      wsprintf(szMsgErreur, _T("Impossible d'écrire dans le stream"));
    }
  }
...
BOOL TPNGFile::SaveToFile(const TCHAR * szFileName, TCHAR *szMsgErreur) {
  BITMAPFILEHEADER bmfHeader;
  BITMAPINFOHEADER BitmapInfoHeader;
  DWORD dwSizeBits;
...
//---------------------------------------------------------------------------
void TPNGFile::GetBits(HDC hdc, RECT &RectDC, RECT &RectImg) {
  LPBITMAPINFO lpBmi;
...
//---------------------------------------------------------------------------
void TPNGFile::GetBits(HDC hdc, HBITMAP hBitmap) {
  LPBITMAPINFO lpBmi;
...
//---------------------------------------------------------------------------
void TPNGFile::GetBits(void *lpBits, DWORD MaxSize) {
  DWORD dwSizeBits;
...
//---------------------------------------------------------------------------
void TPNGFile::SetBits(HDC hdc, HBITMAP hBitmap) {
  LPBITMAPINFO lpBmi;
