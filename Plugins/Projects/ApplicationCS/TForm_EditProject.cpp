...
AnsiString TForm_EditProject::Get_TypeCompiler(void) {

	if (ComboBox_Compilateur->ItemIndex == -1) return _T("");

	return ListCompilers[ComboBox_Compilateur->ItemIndex];
}

bool TForm_EditProject::Set_TypeCompiler(AnsiString NewTypeCompiler) {
	int i;
