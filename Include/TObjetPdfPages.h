...
#ifdef In_TObjetPdfPagesH
#error "Inclusion circulaire de TObjetPdfPages"
#endif // In_TObjetPdfPagesH

#define In_TObjetPdfPagesH

#ifndef TObjetPdfPagesH
#define TObjetPdfPagesH
...
//! @brief Objet Pages
//!
//! Cette classe (@c TObjetPdfPages) est un container de pages PDF.
//!
//! @author Denis ROBERT
//!
//! @sa TObjetPdfPage
...
class TObjetPdfPages: public TObjetPdf {
private:

protected:
  std::vector<TObjetPdfPage *> Pages;
...
public:
  ...
  void AddPage(TObjetPdfPage *ObjetPdfPage);
