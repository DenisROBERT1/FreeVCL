...
#ifdef In_TListBoxItemsH
#error "Inclusion circulaire de TListBoxItems"
#endif // In_TListBoxItemsH

#define In_TListBoxItemsH

#ifndef TListBoxItemsH
#define TListBoxItemsH
...
//! @class TListBoxItems
//!
//! @brief Définition de la classe TListBoxItems
//!
//! Cette classe permet de gérer les chaînes d'une list-box.
//!
//! @author Denis ROBERT
//-----------------------------------------------------------------------------

class TListBoxItems: public TStrings {
protected:
  HWND FHandle;

	virtual TObject *FASTCALL GetObject(int Index);
...
public:
  ...
  //! @brief Propriété Handle: Identifiant système du composant
	//!
	//! Cette propriété permet de lire le handle de la list-box associée à la
	//! liste d'items. Cette propriété est utilisée par le système, en général le
	//! programmeur n'en a pas l'utilité.
  //---------------------------------------------------------------------------

  DECLARE_PROPERTY(TListBoxItems, HWND, Handle);
